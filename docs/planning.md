...
1) tiek izveidot batch -> batchproduct -> taski ar aktīviem Topproduct(IsActive=true)+toppartsteps(IsActive=true)
...
2) DB izveidojas taski tikai ar aktīvajiem ProductToppart+toppartsteps

3) Problēma - tiek izveidoti taski arī no neaktīviem stepiem
