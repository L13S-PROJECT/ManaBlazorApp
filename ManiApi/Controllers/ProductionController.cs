...
(
    ...
    while (await r.ReadAsync())
    {
        list.Add(new
        {
            ...
            ClaimedBy = r.IsDBNull(18) ? (int?)null : r.GetInt32(18),
            StartedAt = r.IsDBNull(19) ? (DateTime?)null : r.GetDateTime(19),
            EmployeeName = r.IsDBNull(20) ? null : r.GetString(20),
            FinishedAt = r.IsDBNull(21) ? (DateTime?)null : r.GetDateTime(21),
            QtyDone = r.IsDBNull(22) ? 0 : r.GetInt32(22),
            RalColorId = r.IsDBNull(23) ? (int?)null : r.GetInt32(23),
            RalColorName = r.IsDBNull(24) ? null : r.GetString(24),
            EstimatedTotalMinutes = r.IsDBNull(25) ? 0 : r.GetInt32(25),
            EstimatedStartMinutes = r.IsDBNull(26) ? 0 : r.GetInt32(26),
            ActualMinutes = r.IsDBNull(27) ? 0 : r.GetInt32(27),
        });
    }
